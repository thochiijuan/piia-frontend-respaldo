...
import GeovisorWorkspace
  from "./components/GeovisorWorkspace";
import DepartmentVariableBootstrap
  from "./components/DepartmentVariableBootstrap";
import MunicipalityVariableBootstrap
  from "./components/MunicipalityVariableBootstrap";


export default function HomePage() {
  return (
    <>
      <DepartmentVariableBootstrap />
      <MunicipalityVariableBootstrap />
